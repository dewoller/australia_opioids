...
df_nquarter %>%
  ...
  ggplot( aes( pct,nquarter, color=type )) + geom_point() + geom_path()
...
Overall combined, percentages of each category
```{r quarters_by_age}
...
df_tograph %>%
  ...
  geom_point() + 
  geom_path() +
  ggtitle( 'overall combined opioid pct by age group and usage category ')
...
df_tograph %>%
  ...
  geom_point() + 
  geom_path() +
  ggtitle( 'overall combined benzo pct by age group and usage category ')
...
df_tograph %>%
  ...
  geom_point() + 
  geom_path() +
  ggtitle( 'overall combined both pct by age group and usage category ')


```


Overall combined, percentages of each age group
...
df_tograph %>%
  ...
  geom_point() + 
  geom_path() +
  ggtitle( 'overall combined both (double dipper benzo and opioid in same quarter) pct by age group and usage category ')

```



Overall combined, percentages of each category by state 
